...
class UserFactory extends Factory
{
    ...
    /**
     * Indicate that the user belongs to the given company.
     */
    ...
    {
        return $this->afterCreating(fn (User $user) => $user->assignRole(Role::findOrCreate('admin')));
    }
    ...
    {
        return $this->afterCreating(fn (User $user) => $user->assignRole(Role::findOrCreate('technician')));
    }
